...
class Address {
	...
	constructor( address ) {
		...
		Object.defineProperties( this, {
			...
			/**
			 * Exposes parsed properties of embedded address.
			 *
			 * @name Address#parsed
			 * @property {RawNodeAddress}
			 * @readonly
			 */
			parsed: { value: parsed },

			/**
			 * Exposes IP port number of embedded address.
			 *
			 * @name Address#port
			 * @property {int}
			 * @readonly
			...
			/**
			 * Exposes host's name or IP of embedded address.
			 *
			 * @name Address#host
			 * @property {string}
			 * @readonly
	 ...
	 */
	toSocketOptions() {
		const options = Object.assign( {}, this.parsed );
	...
	switch ( typeof address ) {
		...
		case "object" :
			if ( address ) {
				...
				return new Address( Address.compileString( address ) );
			}
